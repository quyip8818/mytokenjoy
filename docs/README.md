...
| 文档                                                   | 读者               | 内容                                                  |
| ------------------------------------------------------ | ------------------ | ----------------------------------------------------- |
| **[plan.md](./plan.md)**                               | 研发 / 架构        | **工程 backlog 唯一入口**（NewAPI、fake API、前端迁移等） |
...
| [前端架构优化与模块化建议.md](./前端架构优化与模块化建议.md) | 前端           | 模块化指南与目标结构                                  |
| [Roadmap.md](./Roadmap.md)                             | 全员               | 产品差距（未实现能力）                                |
| [下一步工作清单.md](./下一步工作清单.md)               | 架构 / 前后端      | 发布门禁、Phase 3 触发条件                            |

### 归档与历史

| 文档 | 说明 |
| --- | --- |
| [archive/](./archive/) | 已完成计划（MSW 去除、Keys 兼容清理规格等） |
| [PRD.md](./PRD.md) | **历史副本**，权威 PRD 见 [TokenJoy-PRD.md](./TokenJoy-PRD.md) |
| [MSW去除与后端对齐计划.md](./MSW去除与后端对齐计划.md) | 已完成，指向 archive + plan |
| [清理兼容与死代码-下一步.md](./清理兼容与死代码-下一步.md) | 已归档，指向 plan §3 |
