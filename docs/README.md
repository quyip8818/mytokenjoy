...
| [Backend-SaaS多租户改造.md](./Backend-SaaS多租户改造.md) | 产品 / 后端 / 架构 | SaaS 多企业（Company / 成员 / 公司钱包）         |
| [NewAPI-SaaS多企业配置.md](./NewAPI-SaaS多企业配置.md)   | 运维 / 后端        | NewAPI 单集群多企业隔离与部署配置                |
| [Frontend-API契约.md](./Frontend-API契约.md)             | 前后端             | **81** 个管理面 REST 端点 + **§10** SaaS 10 端点 |
| [Frontend-开发指南.md](./Frontend-开发指南.md)           | 前端               | 目录结构、路由、API DI、页面 Hook、测试          |
| [Backend-设计.md](./Backend-设计.md)                     | 后端               | 分层、Store、配置、看板用量、维护要点            |
| [Backend-结构优化.md](./Backend-结构优化.md)             | 后端 / 架构        | 代码结构审阅、模块化收口、分阶段重构计划         |
| [Backend-存储架构.md](./Backend-存储架构.md)             | 后端               | Postgres 表结构、Repository 映射与实体关系       |
