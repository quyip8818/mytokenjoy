...
| 运行面 | `usage_buckets`, `outbox`, `rebalance_queue`, `overrun_queue`, `scheduler_locks`, `relay_sync_cursors` |
...
| Cookie | 面 |
| ------ | -- |
| `tokenjoy_session_member` | 企业面 |
| `tokenjoy_platform_session` | 平台面 |
...
| `relay_sync_cursors` | NewAPI 日志补偿轮询游标 |
