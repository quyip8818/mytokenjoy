...
> **预算副作用**：[Backend-Projector.md](./Backend-Projector.md) · [Backend-预算累计架构.md](./Backend-预算累计架构.md)  
...
- 详见 [Backend-Projector.md](./Backend-Projector.md) · [Backend-预算累计架构.md](./Backend-预算累计架构.md)
