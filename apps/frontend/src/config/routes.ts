...
const ROUTE_DEFINITIONS_INTERNAL = [
  // ─── 数据看板（默认展开）───
  {
    ...
    label: '成本看板',
    icon: BarChart3,
    requiredPermissions: [PERMISSION.DASHBOARD_READ],
  ...
  },
  {
    ...
    label: '供应商 Key',
    icon: Key,
    requiredPermissions: [PERMISSION.KEYS_MANAGE, PERMISSION.KEYS_READ],
  ...
  },
  {
    ...
    label: '预警规则',
    icon: ShieldAlert,
    requiredPermissions: [PERMISSION.BUDGET_ADMIN],
  ...
  },
  {
    ...
    label: '组织架构',
    icon: Building2,
    requiredPermissions: [PERMISSION.ORG_MANAGE, PERMISSION.ORG_READ],
