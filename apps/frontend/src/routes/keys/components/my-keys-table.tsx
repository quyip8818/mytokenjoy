              ...
              <PermissionGate write permission={PERMISSION.SELF_KEYS}>
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem onClick={() => onRotate(key)}>重新生成</DropdownMenuItem>
                    <DropdownMenuItem onClick={() => void onToggle(key)}>
                      {key.status === 'active' ? '禁用' : '启用'}
                    </DropdownMenuItem>
                    <DropdownMenuItem className="text-red-600" onClick={() => onDelete(key)}>
                      删除
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
