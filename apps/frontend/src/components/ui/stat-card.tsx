...
export function StatCard({
    ...
    return (
      ...
      >
        <CardContent className="p-4">
          ...
          <p
            className={cn(
              'mt-2 text-xl font-semibold tracking-tighter tabular-nums',
              accent && 'text-primary',
            )}
          >
            {value}
  ...
  return (
    <Card
      className={cn(
        'border-transparent shadow-card transition-all duration-200 hover:-translate-y-0.5 hover:shadow-card-hover',
        className,
      )}
    >
      <CardContent
