        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              <TableHead className="px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide">姓名</TableHead>
              <TableHead className="px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide">角色</TableHead>
              <TableHead className="px-4 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide text-right">操作</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {filtered.length === 0 ? (
            ...
            <ul className="divide-y divide-border-subtle">
              {results.map((m) => (
                ...
                >
                  ...
                  <Button variant="ghost" size="sm" className="h-7 text-xs" onClick={() => onAdd(m.id)}>
                    添加
                  </Button>
                </li>
              ))}
