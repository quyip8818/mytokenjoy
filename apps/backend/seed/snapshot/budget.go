	...
	return []types.BudgetNode{
		{
			...
			Budget: 120000, Consumed: contract.DemoRootConsumed(), ReservedPool: &reserved15000, Period: pkgbudget.PeriodMonthly,
			Children: []types.BudgetNode{
				{
					ID: contract.IDDept2, Name: "技术部", ParentID: &dept2,
					Budget: 50000, Consumed: techConsumed, ReservedPool: &reserved2000, Period: pkgbudget.PeriodMonthly,
					Children: []types.BudgetNode{
						{ID: contract.IDDept3, Name: "后端组", ParentID: &dept3, Budget: 20000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept3], ReservedPool: &reserved1500, Period: pkgbudget.PeriodMonthly},
						{ID: contract.IDDept4, Name: "前端组", ParentID: &dept4, Budget: 15000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept4], Period: pkgbudget.PeriodMonthly},
						{ID: contract.IDDept5, Name: "测试组", ParentID: &dept5, Budget: 10000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept5], Period: pkgbudget.PeriodMonthly},
					},
				},
				{ID: contract.IDDept6, Name: "产品部", ParentID: &dept6, Budget: 20000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept6], Period: pkgbudget.PeriodMonthly},
				{ID: contract.IDDept7, Name: "市场部", ParentID: &dept7, Budget: 15000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept7], Period: pkgbudget.PeriodMonthly},
				{ID: contract.IDDept8, Name: "行政部", ParentID: &dept8, Budget: 16000, Consumed: contract.DemoLeafDeptConsumed[contract.IDDept8], Period: pkgbudget.PeriodMonthly},
			},
		},
	}
}
...
func buildProjects() []types.Project {
	return []types.Project{
		{
			ID: contract.IDProject1, Name: "AI 创新项目组", Budget: 15000,
			...
			MemberBudgets: map[uuid.UUID]float64{
				contract.IDMember1: 6000,
				contract.IDMember4: 5000,
				contract.IDMember6: 3000,
			},
			OwnerDepartmentID: contract.IDDept3,
		},
		{
			ID: contract.IDProject4, Name: "内部效率工具", Budget: 8000,
			Consumed:  contract.DemoProjectConsumed[contract.IDProject4],
			MemberIDs: []uuid.UUID{contract.IDMember15, contract.IDMember16},
			MemberBudgets: map[uuid.UUID]float64{
				contract.IDMember15: 4000,
				contract.IDMember16: 4000,
			},
