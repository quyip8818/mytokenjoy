...
func buildModels() []types.ModelInfo {
	...
	return []types.ModelInfo{
		...
		{ID: contract.IDModel1, CompanyID: contract.DefaultCompanyID, Provider: "custom", Type: "deepseek-v4-pro", Name: "DeepSeek V4 Pro", MaxContext: 128000, Enabled: true, Capabilities: []string{"chat"}, Source: "seed"},
		{ID: contract.IDModel11, CompanyID: contract.DefaultCompanyID, Provider: "custom", Type: "deepseek-v4-flash", Name: "DeepSeek V4 Flash", MaxContext: 128000, Enabled: true, Capabilities: []string{"chat"}, Source: "seed"},
	}
}
