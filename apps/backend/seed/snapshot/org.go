...
func buildDepartments() []types.Department {
	...
	return []types.Department{
		{
			ID: "dept-1", Name: "总公司", ParentID: nil, MemberCount: 41,
			Children: []types.Department{
				{
					ID: "dept-2", Name: "技术部", ParentID: &dept2Parent, MemberCount: 21,
					Children: []types.Department{
						...
						{ID: "dept-5", Name: "测试组", ParentID: &dept5Parent, MemberCount: 6},
					},
				},
				{ID: "dept-6", Name: "产品部", ParentID: &dept6Parent, MemberCount: 6},
				{ID: "dept-7", Name: "市场部", ParentID: &dept7Parent, MemberCount: 6},
				{ID: "dept-8", Name: "行政部", ParentID: &dept8Parent, MemberCount: 7},
			},
		},
	}
}
...
func buildSyncLogs(refDate string) []types.SyncLog {
	return []types.SyncLog{
		...
		{ID: "sync-9", Time: "2026-06-15 02:00", Type: "scheduled", Result: "partial_failure", Detail: "成功 36 人，失败 2 人"},
		...
		{ID: "sync-12", Time: "2026-06-13 02:00", Type: "scheduled", Result: "success", Detail: "初始化同步 41 人"},
	}
}
