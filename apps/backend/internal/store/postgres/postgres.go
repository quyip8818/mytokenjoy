...
func (s *Store) ModelDiscount() store.ModelDiscountRepository {
	return &modelDiscountRepo{db: s.pool}
}
...
func (s *Store) Redemption() store.RedemptionRepository {
	return newRedemptionRepo(s.pool)
}
