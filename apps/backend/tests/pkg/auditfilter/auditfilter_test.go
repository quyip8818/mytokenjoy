...
func TestFilterByDateRange(t *testing.T) {
	...
	filtered := auditfilter.FilterByDateRangeCreatedAt(items, "2026-06-10", "2026-06-20", func(item sampleLog) string {
...
func TestFilterByKeyword(t *testing.T) {
	...
	filtered := auditfilter.FilterByKeyword(items, "key", []func(sampleLog) string{
