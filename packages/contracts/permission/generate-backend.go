...
func main() {
	...
	embedManifestPath := filepath.Join(repoRoot, "apps", "backend", "internal", "domain", "grants", "manifest.json")
	keysPath := filepath.Join(repoRoot, "apps", "backend", "internal", "domain", "grants", "keys.go")
